...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	var check_gf_sing_with_you:FlxUICheckBox;
	var check_gf_sing:FlxUICheckBox;
	var stumnotesvis:FlxUICheckBox;
	function addSectionUI():Void
	{
		...
		check_gf_sing_with_you = new FlxUICheckBox(10, 300, null, null, "gf singing with you?", 100);
		check_gf_sing_with_you.name = 'check_gf_sing_with_you';

		check_gf_sing = new FlxUICheckBox(10, check_gf_sing_with_you.y + 70, null, null, "gf singing?", 100);
		check_gf_sing.name = 'check_gf_sing';
		...
		stumnotesvis = new FlxUICheckBox(10, check_gf_sing_with_you.y + 30, null, null, "stum notes vis?", 100);
		stumnotesvis.name = 'stumnotesvis';
		...
		tab_group_section.add(stumnotesvis);

		tab_group_section.add(check_gf_sing_with_you);
		tab_group_section.add(check_gf_sing);
		...
		for(i in velChanges){
		 ...
		 for (i in sectionInfo)
 		{
			...
			var daStyle = i[3];
 			...
 			var note:Note = new Note(daStrumTime, daNoteInfo % 4, null, false,0,true,daStyle);
	...
	private function addNote(rightClick:Bool):Void
	{
		...
		var noteSus = 0;
		var notetype = style[this.notetype];
