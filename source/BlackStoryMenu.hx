...
class BlackStoryMenu extends MusicBeatState
{
	...
	var grpWeekText:FlxTypedGroup<BlackMenuItem>;
	...
	override function create()
	{
		...
		grpWeekText = new FlxTypedGroup<BlackMenuItem>();
		add(grpWeekText);
		...
		{
			var weekThing:BlackMenuItem = new BlackMenuItem(0, yellowBG.y + yellowBG.height + 10, i);
